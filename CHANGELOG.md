...
* Видалено застарілі переклади ядра Flarum (підтримується версія `2.0` або вище).
* Видалено застарілі переклади валідації (підтримується версія `2.0` або вище).
...
**Видалено підтримку застарілих розширень**:
...
Усі зміни: [v1.54.1...v2.0.0](https://github.com/flarum-lang/ukrainian/compare/v1.54.1...v2.0.0).
